...
class App extends React.Component { 
  ...
  scrollUp = e =>{
    ...
    if (this.state.data[1].title == this.state.flag) {
...
  startScrollUp= e =>{
  ...
  scrollUp1= e =>{
    ...
    if (this.state.data1[1].title == this.state.flag) {
        ...
        <div className={style.listContainer}>
         ...
         className={this.state.animate ? style.animate : ''}
          style={{marginTop:this.state.listMarginTop}}>
                 ...
                 this.state.data.map((item,index)=>{
                     return (
                         ...
                         <li className={style.li}>
                             ...
                             {/* <span style={{width:'0',height:'0'}}>{item.title}</span>
                             <span style={{width:'0',height:'0'}}>{item.title}</span> */}
                         </li>
                     )
                 })
            ...
            <div className={style.listContainer}>
         <ul id="scrollList1"
         className={this.state.animate1 ? style.animate : ''}
